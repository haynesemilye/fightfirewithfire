...
public class BasicScenarios {
  ...
  @Test
  public void threeFirefighterTripleFire() throws FireproofBuildingException {
    City basicCity = new CityImpl(4, 4, new CityNode(1, 1));
    FireDispatch fireDispatch = basicCity.getFireDispatch();
    ...
    Assert.assertEquals(7, totalDistanceTraveled);
